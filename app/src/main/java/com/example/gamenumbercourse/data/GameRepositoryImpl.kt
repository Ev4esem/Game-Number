package com.example.gamenumbercourse.data
...
object GameRepositoryImpl : GameRepository {
    ...
    override fun generateQuestion(maxSumValue : Int, countOfOptions : Int) : Question {
        ...
        val from = maxOf(rightAnswer - countOfOptions, MIN_ANSWER_VALUE)
        val to = minOf(maxSumValue, rightAnswer + countOfOptions)
